...
public class Message extends javax.swing.JFrame {
    ...
    public void tableLoad() {
        int tl = table.getSelectedRow();
        String mid = table.getValueAt(tl, 0).toString();
        String me = table.getValueAt(tl, 1).toString();
        id.setText(mid);
        t1.setText(me);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, null, new java.awt.Color(0, 0, 0), null, null), "Message", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 14), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        table.setAlignmentX(1.8F);
        table.setAlignmentY(1.8F);
        ...
        setSize(new java.awt.Dimension(912, 530));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            stmt = conn.createStatement();
            String mes = t1.getText();

            String sql = "INSERT INTO message(Message) VALUES('" + mes + "')";
            stmt.execute(sql);
